...
data class  KitOrderKit(
    ...
    @SerializedName("cardListConfirmed") val cardListConfirmed: List<CardListConfirmed>,
    @SerializedName("cardListNotConfirmed") val cardListNotConfirmed: List<CardListNotConfirmed>
) : Serializable